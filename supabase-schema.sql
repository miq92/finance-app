...
-- 5. SETTINGS (key-value store for income, budget, EV rate etc.)
...
-- Enable RLS so only authenticated users can access their data.
-- Skip this block if you're using the anon key for personal use only.
--
